...
# BugReport 12: Некорректная надпись
...
# BugReport 13: UI-баг - Элемент вращается при скролле
...
# BugReport 14: Кнопка ведет не по верному адресу
...
# BugReport 15: Ошибка локализации
